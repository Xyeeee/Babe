...
# IMPORTANT #
# Due to the 12 hour limit on Google Colab and the tim
# e it would take to convert the dataset into features, the load_and_cache_examples() function has been modified
